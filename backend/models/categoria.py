...
"""
    ...
    Es el encargado de gestionar las categorias de los productos. Permite crear, actualizar, eliminar y leer categorias.

    Es usado por el administrador para gestionar la base de los productos.
"""
